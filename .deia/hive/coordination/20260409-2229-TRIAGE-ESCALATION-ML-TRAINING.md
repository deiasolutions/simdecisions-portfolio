...
**Date:** 2026-04-09 22:29:27 UTC
**Reason:** 3 requeue attempts (max 3)
**Status:** NEEDS MANUAL REVIEW

## Summary

Spec `SPEC-ML-TRAINING-V1.rejection.rejection.rejection.rejection.rejection.rejection.md` has been requeued 3 times and failed each time.
Automated triage has moved it to `_escalated/` for manual review.

## Triage History

- 2026-04-09T22:15:46.234771Z — requeued (empty output)
- 2026-04-09T22:19:27.114438Z — requeued (empty output)
- 2026-04-09T22:24:27.161484Z — requeued (empty output)

## Next Steps

1. **Review spec file** in `queue/_escalated/SPEC-ML-TRAINING-V1.rejection.rejection.rejection.rejection.rejection.rejection.md`
...
# Rejection: SPEC-ML-TRAINING-V1.rejection.rejection.rejection.rejection.rejection.md

**Type:** GATE0_FAIL
**Time:** 2026-04-09T17:15:39.442254
