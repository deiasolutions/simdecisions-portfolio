...
Spec `SPEC-MW-VERIFY-001-full-audit.rejection.rejection.rejection.md` has been requeued 3 times and failed each time.
Automated triage has moved it to `_escalated/` for manual review.

## Triage History

- 2026-04-09T22:15:46.257826Z — requeued (empty output)
- 2026-04-09T22:19:27.123370Z — requeued (empty output)
- 2026-04-09T22:24:27.167537Z — requeued (empty output)

## Next Steps

1. **Review spec file** in `queue/_escalated/SPEC-MW-VERIFY-001-full-audit.rejection.rejection.rejection.md`
...
# Rejection: SPEC-MW-VERIFY-001-full-audit.rejection.rejection.md

**Type:** GATE0_FAIL
**Time:** 2026-04-09T17:15:39.661502
