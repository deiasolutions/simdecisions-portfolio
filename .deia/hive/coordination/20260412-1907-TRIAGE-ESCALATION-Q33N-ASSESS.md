...
Spec `SPEC-Q33N-ASSESS-UNARCHIVED-TASKS-001.md` has been requeued 3 times and failed each time.
...
1. **Review spec file** in `queue/_escalated/SPEC-Q33N-ASSESS-UNARCHIVED-TASKS-001.md`
...
- Every `*.md` file directly under `C:/Users/davee/OneDrive/Documents/GitHub/simdecisions/.deia/hive/tasks/` (ignore `_archive/`)
