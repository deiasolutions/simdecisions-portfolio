# TRIAGE ESCALATION: DES-DECISION
...
Spec `SPEC-DES-DECISION-001.md` has been requeued 3 times and failed each time.
...
1. **Review spec file** in `queue/_escalated/SPEC-DES-DECISION-001.md`
