...
- POST heartbeats to http://localhost:8420/build/heartbeat every 3 minutes with JSON:
  {"task_id": "2026-03-16-1022-SPEC-w2-05-des-canvas-visual", "status": "running", "model": "sonnet", "message": "working"}
...
1. POST http://localhost:8420/build/claim with JSON:
   {"task_id": "2026-03-16-1022-SPEC-w2-05-des-canvas-visual", "files": ["path/to/file1.py", "path/to/file2.py"]}
...
3. When done with a file, release it early so other bees can proceed:
   ...
   {"task_id": "2026-03-16-1022-SPEC-w2-05-des-canvas-visual", "files": ["path/to/file1.py"]}
