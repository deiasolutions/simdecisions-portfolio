# BUG-031 (RE-QUEUE): Code explorer click returns "Error loading file Bad Request URI"

## Background — Why Re-Queued
Attempted 3 times (BUG-031 haiku, BUG-031-SONNET, BUG-039 fix-spec). First bee wrote correct fix but source changes never landed in the file. BUG-039 fix-spec failed due to file path error. The fix is known — apply it.
...
- [ ] Error handling for genuinely missing files (404)
- [ ] All new tests pass
...
## Re-Queue Metadata
- Original spec: `_done/2026-03-17-SPEC-TASK-BUG031-code-explorer-click-error.md`
- Attempt 2: `_done/2026-03-17-2333-SPEC-fix-TASK-BUG031-code-explorer-click-error.md`
- Attempt 3: `_done/2026-03-18-0819-SPEC-fix-TASK-BUG039-code-explorer-click-bad-request.md` (file path error)
- Failure reason: Source changes never landed despite bee claiming COMPLETE
