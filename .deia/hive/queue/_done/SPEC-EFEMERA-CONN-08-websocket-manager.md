# SPEC-EFEMERA-CONN-08: Port WebSocket Manager
...
class ConnectionManager:
    ...
    def touch_presence(self, user_id: str) -> None
```
...
- [ ] message type: saved to store and broadcast
- [ ] typing type: broadcast to channel (not saved to store)
...
- [ ] Endpoint registered via app.add_api_websocket_route("/efemera/ws")
- [ ] All tests pass

## Smoke Test
- [ ] `cd hivenode && python -m pytest tests/hivenode/test_efemera_ws.py -v` — all pass
...
## Response File
20260328-EFEMERA-CONN-08-RESPONSE.md
