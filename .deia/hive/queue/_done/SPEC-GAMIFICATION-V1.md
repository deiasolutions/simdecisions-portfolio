...
- [ ] XP calculator scores events from Event Ledger
- [ ] Badge engine awards badges based on XP thresholds
- [ ] Progression state tracks user level and unlocks
- [ ] Dashboard widget displays user progression
- [ ] API endpoints serve gamification data
- [ ] Four-factor profile (rho-pi-sigma-tau) computes from events
