# SPEC-SKILL-SCAFFOLD-001: Skill Directory + First Three Internal Skills
...
- [ ] .deia/skills/internal/ directory structure created
- [ ] bee-dispatch SKILL.md + governance.yml written in agentskills.io format
- [ ] spec-writer SKILL.md + governance.yml written in agentskills.io format
- [ ] hive-diagnostics SKILL.md + governance.yml written in agentskills.io format
- [ ] .deia/skills/imported/.gitkeep exists
- [ ] Existing factory-health-check skill NOT overwritten
...
Note: `.deia/skills/internal/factory-health-check/` already exists with SKILL.md and governance.yml. Do NOT overwrite or delete it.
...
- [ ] All 7 files created (.deia/skills/internal/bee-dispatch/SKILL.md, governance.yml, spec-writer/SKILL.md, governance.yml, hive-diagnostics/SKILL.md, governance.yml, .deia/skills/imported/.gitkeep)
- [ ] Each SKILL.md has valid agentskills.io YAML frontmatter (name, description present, constraints met)
...
## Triage History
- 2026-04-12T19:47:40.353989Z — requeued (empty output)
- 2026-04-12T19:52:40.363318Z — requeued (empty output)
