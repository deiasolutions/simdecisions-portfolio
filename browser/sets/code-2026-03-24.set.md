...
Shell provides ONLY: menu bar (top) + status bar (bottom toolbar).
Everything else is an applet declared in this layout.

Layout regions (all applets, all chrome-suppressed):
